...
export namespace prthgts
{
    ...
    */
    export class CUtility
    {
         ...
         * @return number
        */
        public GenRandomNumber(min:number, max:number, isRound:boolean):number
        {
         ...
         * @return std::string 
         */
        public GenRandomAlphanumeric(length:number):string
        {
            let result:string = "";
            ...
            {
                const j:number = this.GenRandomNumber(0, this.m_alphanumeric.length - 1, true);
            ...
            switch (letterCase)
            {
                ...
                case 2:
                {
                    for (let i:number = 0; i < input.length; i++)
                    {
                        ...
                        const mixedcase:number = this.GenRandomNumber(0, 1, true);
